      ...
      <section class="text-gray-600 body-font">
        <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          ...
          <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            ...
            <p class="mb-8 leading-relaxed">Get Rs 9000 HealthCash</p>
            <div>
              <div class="w-full">
            ...
            <div class="flex w-full md:justify-start justify-center items-end">
              <div class="relative mr-4 lg:w-full xl:w-1/2 w-2/4">
                ...
                <input
                  ...
                  id="hero-field"
                  name="hero-field"
                  placeholder="example@134.gmail.com"
              ...
              <button class="inline-flex w-2/5 text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-sm">
                Get Link
              </button>
            </div>
            <p class="text-sm mt-2 text-gray-500 mb-8 w-full">
              GET the link of your app at your email{" "}
            </p>
